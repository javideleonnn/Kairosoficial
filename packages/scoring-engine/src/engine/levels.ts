 ...
 * (amplitud real ~19.1 puntos — ver hallazgo del Módulo 7 sobre por qué el
 * rango real es mucho más angosto que 0-100: cada dimensión depende de
 * solo 2-3 de los 5 bloqueos). Las 5 bandas dividen ese rango real en
 * partes iguales, con los extremos abiertos (0 y 100) para cualquier caso límite.
 */
